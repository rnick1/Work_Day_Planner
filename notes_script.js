...
// Weekends must not be included
// Add event handlers to the submit buttons. These will save the entry on local storage.
// 
// Attach event handlers to the save button class
// Run an alert if the user clicks save an no text has been entered
// Have the text save to local storage 
// Then have the text display in place of the text box
